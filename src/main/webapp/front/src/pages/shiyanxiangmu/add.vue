...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="实验名称" prop="shiyanmingcheng">
            <el-input  v-model="ruleForm.shiyanmingcheng" 
                placeholder="实验名称" clearable :readonly=" false  ||ro.shiyanmingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="实验室" prop="shiyanshi">
            <el-input  v-model="ruleForm.shiyanshi" 
                placeholder="实验室" clearable :readonly=" false  ||ro.shiyanshi"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="教师账号" prop="jiaoshizhanghao">
            <el-input  v-model="ruleForm.jiaoshizhanghao" 
                placeholder="教师账号" clearable :readonly=" false  ||ro.jiaoshizhanghao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="实验要求" prop="shiyanyaoqiu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="实验要求"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="实验内容" prop="shiyanneirong">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/xueyuanxinxi/xueyuan', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`shiyanxiangmu/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('shiyanxiangmu/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post(`shiyanxiangmu/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
