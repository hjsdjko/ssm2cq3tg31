    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="课程分类" prop="kechengfenlei">
            <el-input  v-model="ruleForm.kechengfenlei" 
                placeholder="课程分类" clearable :readonly=" false  ||ro.kechengfenlei"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="课程计划" prop="kechengjihua">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="课程计划"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="教学大纲" prop="jiaoxuedagang">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="教学大纲"
