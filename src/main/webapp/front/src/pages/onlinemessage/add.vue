...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="姓名" prop="name">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="电话" prop="mobile">
            <el-input  v-model="ruleForm.mobile" 
                placeholder="电话" clearable :readonly=" false  ||ro.mobile"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="留言内容" prop="content">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="留言内容"
